      ...
      tiers: [
        {
          ...
          price: '24 GBP',
          unit: 'per year',
          body: 'The full archive, and each issue the day it goes to press.',
          includes: ['Every issue since 2019', 'Reader app with no tracking', 'Cancel any time'],
          cta: 'Subscribe',
        },
        {
          name: 'Print',
          price: '68 GBP',
          unit: 'per year',
          body: 'Four issues, posted flat, on paper worth keeping on a shelf.',
          includes: ['Four printed issues', 'Digital archive included', 'Free postage worldwide'],
          cta: 'Subscribe',
          featured: true,
        },
        {
          ...
          price: '180 GBP',
          unit: 'per year',
          body: 'Funds one commission a year from a writer nobody has published yet.',
          includes: ['Everything in Print', 'Your name in the back', 'An invitation to the launch'],
          cta: 'Become a patron',
        },
      ],
    },
      ...
      tiers: [
        {
          ...
          body: 'A 250 gram bag of whatever we are most excited about that week.',
          includes: ['Roasted to order', 'Free postage', 'Skip or pause any time'],
        ...
        },
        {
          ...
          price: '24 GBP',
          unit: 'every two weeks',
          body: 'One for filter and one for espresso, or two of the same.',
          includes: ['Two 250 gram bags', 'Choose your grind', 'First pick of the micro lots'],
          cta: 'Start a subscription',
          featured: true,
        },
        {
          ...
          price: '90 GBP',
          unit: 'per week',
          body: 'Two kilos a week, and we come and dial in your grinder.',
          includes: ['Two kilos weekly', 'Grinder setup and servicing', 'Barista training for the team'],
          cta: 'Talk to us',
        },
      ],
    },
