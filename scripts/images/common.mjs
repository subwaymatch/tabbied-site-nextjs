// Shared helpers for the showcase image pipeline (extract -> build -> submit ->
...
// z-image caps the prompt; every composed showcase prompt currently sits around
...
// stretched, which is the same rule the artworks follow.
