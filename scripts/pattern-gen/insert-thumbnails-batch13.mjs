// Inserts the batch-13 thumbnail configs into galleryThumbnails.ts, just before
...
if (!blocks.length) {
  console.log('nothing to insert (all batch-13 slugs already present)');
  process.exit(0);
}
