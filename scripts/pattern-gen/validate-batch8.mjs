// Renders every batch-8 pattern in headless Chromium at its gallery-thumbnail
...
console.log(
  `all ${defs.length} batch-8 patterns render, re-draw on reseed and render identically on a transparent background ✓`
);
