// Inserts the batch-6 thumbnail configs into galleryThumbnails.ts, just before
...
if (!blocks.length) {
  console.log('nothing to insert (all batch-6 slugs already present)');
  process.exit(0);
}
