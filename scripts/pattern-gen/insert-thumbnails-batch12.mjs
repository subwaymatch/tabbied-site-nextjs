// Inserts the batch-12 thumbnail configs into galleryThumbnails.ts, just before
...
if (!blocks.length) {
  console.log('nothing to insert (all batch-12 slugs already present)');
  process.exit(0);
}
