// Inserts the batch-10 thumbnail configs into galleryThumbnails.ts, just before
...
if (!blocks.length) {
  console.log('nothing to insert (all batch-10 slugs already present)');
  process.exit(0);
}
