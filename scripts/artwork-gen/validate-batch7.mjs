// Renders every batch-7 artwork in headless Chromium at its gallery-thumbnail
...
console.log(
  `all ${defs.length} batch-7 artworks render, re-draw on reseed and render identically on a transparent background ✓`
);
