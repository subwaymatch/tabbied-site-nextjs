// Inserts the batch-9 thumbnail configs into galleryThumbnails.ts, just before
...
if (!blocks.length) {
  console.log('nothing to insert (all batch-9 slugs already present)');
  process.exit(0);
}
