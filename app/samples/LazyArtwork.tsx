...
/**
 * A gallery tile that builds its artwork only once it approaches the viewport,
 ...
 *
 * The same treatment the main /artworks gallery uses (see
 * components/select-artwork-page/GalleryDoodle.tsx).
 */
