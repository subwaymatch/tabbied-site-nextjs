    ...
    <div
      ...
      <header className={styles.topbar}>
        ...
        <nav className={styles.nav} aria-label="Sections">
          <a data-edit="topbar.a" data-edit-max="28" href="#builds">Builds</a>
          <a data-edit="topbar.a2" data-edit-max="28" href="#geometry">Geometry</a>
          <a data-edit="topbar.a3" data-edit-max="28" href="#workshop">Workshop</a>
          <a data-edit="topbar.a4" data-edit-max="28" href="#process">Ordering</a>
          <a data-edit="topbar.a5" data-edit-max="28" href="#faq">FAQ</a>
        </nav>
      ...
      <main>
          ...
          <div className={styles.heroInner}>
            <div className={styles.heroCopy}>
              ...
              <ul className={styles.chipRow} aria-label="Shop numbers">
                <li>
                  <strong data-edit="hero.strong">612</strong> frames since 2011
                </li>
                <li>
                  <strong data-edit="hero.strong2">0.5 mm</strong> mitre tolerance
                </li>
                <li>
                  <strong data-edit="hero.strong3">≈7 mo</strong> door to door
                </li>
              </ul>
            </div>
            ...
            <div className={styles.heroPanel}>
              ...
              <p className={`${styles.callout} ${styles.calloutA}`}>
                <span data-edit="hero.span" data-edit-max="60">72.5°</span> HEAD ANGLE
              </p>
              <p className={`${styles.callout} ${styles.calloutB}`}>
                <span data-edit="hero.span2" data-edit-max="60">385</span> REACH, MM
              </p>
              <p className={`${styles.callout} ${styles.calloutC}`}>
                <span data-edit="hero.span3" data-edit-max="60">9/6/9</span> BUTTED CRMO
              </p>
        ...
        <section className={styles.philosophy} aria-labelledby="phil-title">
          <div className={styles.sectionHead}>
            ...
            <h2 data-edit="phil.h2" data-edit-max="60" id="phil-title">Why we still light the torch</h2>
          </div>
          <div className={styles.philGrid}>
            <article>
              ...
              <h3 data-edit="phil.h3" data-edit-max="40">Steel is honest</h3>
              <p data-edit="phil.p" data-edit-max="240" data-edit-multiline>
            ...
            <article>
              ...
              <h3 data-edit="phil.h32" data-edit-max="40">Fit is geometry</h3>
              <p data-edit="phil.p2" data-edit-max="240" data-edit-multiline>
            ...
            <article>
              ...
              <h3 data-edit="phil.h33" data-edit-max="40">Repair is a feature</h3>
              <p data-edit="phil.p3" data-edit-max="240" data-edit-multiline>
        ...
        {/* pattern rule */}
        <div data-edit-pattern="main.field" className={styles.patternRule} aria-hidden="true">
          <TabbiedPattern
            pattern={gasket}
        ...
        <section id="builds" className={styles.builds} aria-labelledby="builds-title">
          <div className={styles.sectionHead}>
            ...
            <h2 data-edit="builds.h2" data-edit-max="60" id="builds-title">The builds</h2>
          ...
          <div className={styles.buildFeature}>
            <div data-edit-pattern="builds.field" className={styles.buildFeatureMedia}>
              <TabbiedPattern
                pattern={isometry}
                palette={BLUEPRINT_PALETTE}
                seed="mc-build-22"
            ...
            <div className={styles.buildFeatureBody}>
              ...
              <h3 data-edit="builds.h3" data-edit-max="40">{BUILDS[0].name}</h3>
              ...
              <ul className={styles.specList}>
                {BUILDS[0].specs.map((s, i) => (
                  <li data-edit={`builds.li.${i}`} data-edit-max="80" key={s}>{s}</li>
                ))}
              </ul>
          ...
          <div className={styles.buildCards}>
            {BUILDS.filter((b) => !b.featured).map((b, i) => (
              <article key={b.name} className={styles.buildCard}>
                ...
                <h3 data-edit={`buildCard.h3.${i}`} data-edit-max="40">{b.name}</h3>
                ...
                <ul className={styles.specList}>
                  {b.specs.map((s, i2) => (
                    <li data-edit={`buildCard.li.${i}.${i2}`} data-edit-max="80" key={s}>{s}</li>
                  ))}
                </ul>
        ...
        <section id="geometry" className={styles.geometry} aria-labelledby="geo-title">
          <div data-edit-pattern="geometry.field" className={styles.geoField} aria-hidden="true">
            <TabbiedPattern
              pattern={isometry}
              palette={BLUEPRINT_PALETTE}
              seed="mc-geo-31"
          ...
          <div className={styles.sectionHead}>
            ...
            <h2 data-edit="geometry.h2" data-edit-max="60" id="geo-title">Geometry: Tramontane, stock drawings</h2>
              ...
              >
                <table className={styles.geoTable}>
                  <thead>
                    <tr>
                      {GEO_COLS.map((c, i) => (
                        <th data-edit={`geometry.th.${i}`} key={c} scope="col">
                          {c}
                        </th>
                      ))}
                    </tr>
                  ...
                  <tbody>
                    {GEO_ROWS.map((row, i2) => (
                      <tr key={row[0]}>
                        {row.map((cell, i) =>
                          i === 0 ? (
                            <th data-edit={`geometry.th2.${i2}.${i}`} key={i} scope="row">
                              {cell}
                            </th>
                          ) : (
                            <td data-edit={`geometry.td.${i2}.${i}`} key={i}>{cell}</td>
                          )
                        )}
                      </tr>
                    ))}
        ...
        <section id="workshop" className={styles.workshop} aria-labelledby="ws-title">
          ...
          <div className={styles.wsBody}>
            <div className={styles.sectionHead}>
              ...
              <h2 data-edit="workshop.h2" data-edit-max="60" id="ws-title">One room, two benches</h2>
            </div>
            <div className={styles.wsGrid}>
              ...
              <figure className={styles.wsFig}>
                ...
                />
                <figcaption data-edit="workshop.figcaption" data-edit-max="120" data-edit-multiline>SILVER BRAZING, SEAT CLUSTER / 745 °C, GIVE OR TAKE A FEELING</figcaption>
              </figure>
              <figure className={styles.wsFigSmall}>
                <Figure editId="photo.mistral-lug"
                  ...
                  className={styles.wsFigImg}
                />
                <figcaption data-edit="workshop.figcaption2" data-edit-max="120" data-edit-multiline>LUG № 3, THINNED TO 1.2 MM AT THE POINTS</figcaption>
              </figure>
            </div>
          </div>
        </section>
        ...
        <section className={styles.provisions} aria-labelledby="prov-title">
          <div data-edit-pattern="prov.field" className={styles.provField} aria-hidden="true">
            <TabbiedPattern
              pattern={isometry}
              palette={BLUEPRINT_PALETTE}
              seed="mc-prov-47"
          ...
          <div className={styles.sectionHead}>
            ...
            <h2 data-edit="prov.h2" data-edit-max="60" id="prov-title">Outfitting</h2>
            ...
            {PROVISIONS.map((p, i) => (
              <li key={p.slug} className={styles.provCard}>
                ...
                <div className={styles.provMeta}>
                  <h3 data-edit={`prov.h3.${i}`} data-edit-max="40">{p.name}</h3>
        ...
        <section className={styles.founders} aria-labelledby="founders-title">
          <div className={styles.sectionHead}>
            ...
            <h2 data-edit="founders.h2" data-edit-max="60" id="founders-title">The two of us</h2>
          </div>
          <div className={styles.founderGrid}>
            <article className={styles.founder}>
              ...
              <h3 data-edit="founder.h3" data-edit-max="40">Mara Voss</h3>
              ...
              <p data-edit="founder.p" data-edit-max="240" data-edit-multiline>
            ...
            <article className={styles.founder}>
              ...
              <h3 data-edit="founder.h32" data-edit-max="40">Arjun Mehta</h3>
              ...
              <p data-edit="founder.p2" data-edit-max="240" data-edit-multiline>
        ...
        <section id="process" className={styles.process} aria-labelledby="process-title">
          <div className={styles.sectionHead}>
            ...
            <h2 data-edit="process.h2" data-edit-max="60" id="process-title">Ordering in five operations</h2>
          </div>
            ...
            {PROCESS.map((s, i) => (
              <li key={s.n} className={styles.step}>
                ...
                <div className={styles.stepBody}>
                  ...
                  <p data-edit={`process.p.${i}`} data-edit-max="240" data-edit-multiline>{s.copy}</p>
                </div>
              </li>
            ))}
          </ol>
        ...
        <section id="faq" className={styles.faq} aria-labelledby="faq-title">
          <div className={styles.sectionHead}>
            ...
            <h2 data-edit="faq.h2" data-edit-max="60" id="faq-title">Field notes & questions</h2>
          </div>
        ...
        {/* CTA BAND */}
        <section data-edit-pattern="cta.field" className={styles.ctaBand} aria-labelledby="cta-title">
          <TabbiedPattern
            pattern={gasket}
          ...
          <div className={styles.ctaInner}>
            <h2 data-edit="cta.h2" data-edit-max="60" id="cta-title">The queue opens on the first Monday of each month.</h2>
            <p data-edit="cta.p" data-edit-max="240" data-edit-multiline>Six slots. A drawing with your name on it.</p>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerCol}>
            ...
            <p>
              <a data-edit="footer.a" data-edit-max="28" href="mailto:frames@mistralcycles.example">frames@mistralcycles.example</a>
              <br />
              <a data-edit="footer.a2" data-edit-max="28" href="tel:+14015550172">(401) 555-0172</a>
            </p>
          </div>
        </div>
        <div className={styles.footerRule} />
        <div className={styles.footerBase}>
          <p data-edit="footer.p" data-edit-max="240" data-edit-multiline>© 2026 Mistral Cycles. A fictional workshop, regrettably.</p>
