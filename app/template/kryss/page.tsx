    ...
    <div
      ...
      <header className={s.bar}>
        ...
        <nav aria-label="Sections">
          <a data-edit="bar.a" data-edit-max="28" href="#method">Method</a>
          <a data-edit="bar.a2" data-edit-max="28" href="#work">Work</a>
          <a data-edit="bar.a3" data-edit-max="28" href="#testing">Testing</a>
      ...
      <main id="top">
        ...
        <section className={s.hero}>
          ...
          <div className={s.heroInner}>
            ...
            <h1>
              ...
              useful where
              <br />
              <span data-edit="hero.span" data-edit-max="60">somebody chooses.</span>
            </h1>
        ...
        <figure className={s.bleed}>
          <Figure editId="photo.kryss-sign"
            ...
            priority
          />
          <figcaption data-edit="top.figcaption" data-edit-max="120" data-edit-multiline>K-46, concourse level. One panel, four destinations, no logos.</figcaption>
        </figure>
        ...
        <section id="method" className={s.method} aria-labelledby="method-h">
            ...
            {METHOD.map((m, i) => (
              <li key={m.n}>
                ...
                <div>
                  ...
                  <p data-edit={`method.p.${i}`} data-edit-max="240" data-edit-multiline>{m.d}</p>
                </div>
              </li>
            ))}
          </ol>
          <div className={s.pair}>
            <figure>
              ...
              />
              <figcaption data-edit="method.figcaption" data-edit-max="120" data-edit-multiline>Totem, K-42. Read at 30 m, 12 m and 2 m, in that order.</figcaption>
            </figure>
            <figure>
              ...
              />
              <figcaption data-edit="method.figcaption2" data-edit-max="120" data-edit-multiline>1:100. Cheaper than being wrong at full size.</figcaption>
            </figure>
          </div>
        </section>
          ...
          <div className={s.workInner}>
            ...
            <ol className={s.table}>
              <li className={s.thead} aria-hidden="true">
                ...
                <span data-edit="work.span2" data-edit-max="60">Client</span>
                <span data-edit="work.span3" data-edit-max="60">Type</span>
                <span data-edit="work.span4" data-edit-max="60">Decision points</span>
        ...
        <section id="testing" className={s.testing} aria-labelledby="testing-h">
          ...
          <div className={s.testGrid}>
            ...
            <div className={s.testCol}>
              <p data-edit="testing.p" data-edit-max="240" data-edit-multiline>
              ...
              <p data-edit="testing.p2" data-edit-max="240" data-edit-multiline>
          ...
          <figure className={s.wide}>
            ...
            />
            <figcaption data-edit="testing.figcaption" data-edit-max="120" data-edit-multiline>K-33. When the ceiling is too high to hang from, use the floor.</figcaption>
          </figure>
        </section>
          ...
          <div className={s.studioInner}>
            ...
            <dl className={s.contact}>
              ...
              <div>
                ...
                <dd>
                  <a data-edit="studio.a" data-edit-max="28" href="mailto:skilt@kryss.example">skilt@kryss.example</a>
                </dd>
              </div>
              <div>
                <dt data-edit="studio.dt3" data-edit-max="28">Engage us</dt>
                <dd data-edit="studio.dd" data-edit-max="200" data-edit-multiline>At plan stage. Signs cannot fix a corridor that lies.</dd>
              </div>
              <div>
                <dt data-edit="studio.dt4" data-edit-max="28">Team</dt>
                <dd data-edit="studio.dd2" data-edit-max="200" data-edit-multiline>Seven, of whom two are always on site somewhere</dd>
              </div>
            </dl>
          </div>
        </section>
        ...
        <section id="tiles" className={s.tiles} aria-labelledby="tiles-h">
          <h2 data-edit="tiles.h2" data-edit-max="60" id="tiles-h">Three ways a sign fails</h2>
          ...
          <div className={s.tileGrid}>
              <article key="01">
                ...
                <h3 data-edit="tiles.h3" data-edit-max="40">It is not at a decision</h3>
              ...
              <article key="02">
                ...
                <h3 data-edit="tiles.h32" data-edit-max="40">It uses the wrong name</h3>
              ...
              <article key="03">
                ...
                <h3 data-edit="tiles.h33" data-edit-max="40">It arrives too late</h3>
        ...
        <section id="index" className={s.idx} aria-labelledby="idx-h">
          <h2 data-edit="index.h2" data-edit-max="60" id="idx-h">Typography and materials</h2>
          ...
          <ol className={s.idxList}>
            <li className={s.idxHead} aria-hidden="true">
                <span data-edit="index.span" data-edit-max="60">Element</span>
                <span data-edit="index.span2" data-edit-max="60">Specification</span>
                <span data-edit="index.span3" data-edit-max="60">Minimum</span>
                <span data-edit="index.span4" data-edit-max="60">Note</span>
            </li>
              <li key="Primary destination">
                <span data-edit="index.span5" data-edit-max="60">Primary destination</span>
                <span data-edit="index.span6" data-edit-max="60">Inter, 500</span>
                <span data-edit="index.span7" data-edit-max="60">35 mm cap</span>
                <span data-edit="index.span8" data-edit-max="60">At 12 m reading distance</span>
              </li>
              <li key="Secondary">
                <span data-edit="index.span9" data-edit-max="60">Secondary</span>
                <span data-edit="index.span10" data-edit-max="60">Inter, 400</span>
                <span data-edit="index.span11" data-edit-max="60">22 mm cap</span>
                <span data-edit="index.span12" data-edit-max="60">Never more than four per panel</span>
              </li>
              <li key="Arrow">
                <span data-edit="index.span13" data-edit-max="60">Arrow</span>
                <span data-edit="index.span14" data-edit-max="60">Drawn, house</span>
                <span data-edit="index.span15" data-edit-max="60">Cap height</span>
                <span data-edit="index.span16" data-edit-max="60">Leading edge aligns to type</span>
              </li>
              <li key="Panel">
                <span data-edit="index.span17" data-edit-max="60">Panel</span>
                <span data-edit="index.span18" data-edit-max="60">Anodised aluminium</span>
                <span data-edit="index.span19" data-edit-max="60">3 mm</span>
                <span data-edit="index.span20" data-edit-max="60">Powder coat on the reverse</span>
              </li>
              <li key="Contrast">
                <span data-edit="index.span21" data-edit-max="60">Contrast</span>
                <span data-edit="index.span22" data-edit-max="60">70 % minimum</span>
                <span data-edit="index.span23" data-edit-max="60">LRV difference</span>
                <span data-edit="index.span24" data-edit-max="60">Measured, not judged</span>
              </li>
              <li key="Mounting">
                <span data-edit="index.span25" data-edit-max="60">Mounting</span>
                <span data-edit="index.span26" data-edit-max="60">Suspended or post</span>
                <span data-edit="index.span27" data-edit-max="60">2 100 mm</span>
                <span data-edit="index.span28" data-edit-max="60">Clear headroom</span>
              </li>
          </ol>
        </section>
        ...
        <section id="faq" className={s.faq} aria-labelledby="faq-h">
          ...
          <dl className={s.faqList}>
              <div key="Can you just do the sign">
                <dt data-edit="faq.dt" data-edit-max="28">Can you just do the signs?</dt>
                <dd data-edit="faq.dd" data-edit-max="200" data-edit-multiline>We can, and it will not work. If the corridor lies, no sign fixes it. We would rather tell you that in week one than in year two.</dd>
              </div>
              <div key="How long does a scheme t">
                <dt data-edit="faq.dt2" data-edit-max="28">How long does a scheme take?</dt>
                <dd data-edit="faq.dd2" data-edit-max="200" data-edit-multiline>Four to nine months depending on size. Testing is six weeks of it and it is not the part to compress.</dd>
              </div>
              <div key="Do you handle fabricatio">
                <dt data-edit="faq.dt3" data-edit-max="28">Do you handle fabrication?</dt>
                <dd data-edit="faq.dd3" data-edit-max="200" data-edit-multiline>No. We specify, tender and inspect. Keeping the design and the fabrication separate is how we can reject a batch.</dd>
              </div>
              <div key="What if the building cha">
                <dt data-edit="faq.dt4" data-edit-max="28">What if the building changes?</dt>
                <dd data-edit="faq.dd4" data-edit-max="200" data-edit-multiline>The system is drawn so panels can be replaced individually. Nobody has ever regretted that and several clients have regretted the alternative.</dd>
              </div>
          </dl>
        </section>
      ...
      <footer className={s.footer}>
        <div className={s.footGrid}>
          ...
          <div className={s.footCol}>
            ...
            <ul className={s.footLinks}>
              <li>
                <a data-edit="footer.a" data-edit-max="28" href="#method">Four steps</a>
              </li>
              <li>
                <a data-edit="footer.a2" data-edit-max="28" href="#work">Recent schemes</a>
              </li>
              <li>
                <a data-edit="footer.a3" data-edit-max="28" href="#testing">Testing</a>
              </li>
            </ul>
          </div>
          <div className={s.footCol}>
            ...
            <ul className={s.footLinks}>
              <li>
                <a data-edit="footer.a4" data-edit-max="28" href="#studio">Youngstorget 3</a>
              </li>
              <li>
                <a data-edit="footer.a5" data-edit-max="28" href="#studio">Engage us</a>
              </li>
              <li>
                <a data-edit="footer.a6" data-edit-max="28" href="#studio">The team</a>
              </li>
            </ul>
          </div>
          <div className={s.footCol}>
        ...
        <div className={s.footFine}>
          <p data-edit="footer.p" data-edit-max="240" data-edit-multiline>A fictional wayfinding studio. Prices and times are invented.</p>
          <p>
            Patterns by{' '}
